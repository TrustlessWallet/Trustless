...
export default function MapScreen() {
    ...
    useEffect(() => {
        ...
        const supercluster = new Supercluster({
            radius: 70, // Increased radius for much broader, cleaner grouping
            maxZoom: 16,
        });
    ...
    const handleMarkerPress = (merchant: BtcMapElement) => {
        ...
        // Increase delta to zoom out slightly more
        const latDelta = 0.002;
        const lonDelta = 0.002;

        // Offset the target center downward by 25% of the visible screen height
        // This pushes the physical merchant pin into the upper half of the viewport
