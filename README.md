<a href="https://trustlesswallet.github.io/Trustless/"><img src="https://github.com/user-attachments/assets/b8c370be-840f-4f3e-88a6-5920711ee174" alt="Trustless-logo-dark" height="50" align="middle"></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="https://apps.apple.com/app/apple-store/id6756965117?pt=128138429&ct=github&mt=8"><img src="https://github.com/user-attachments/assets/1c049492-6fb6-43cc-a5eb-0469bbef9b2c" alt="AppStore" height="50" align="middle"></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="https://walletscrutiny.com/iphone/com.btc.trustless/"><img src="https://github.com/user-attachments/assets/7d142492-8520-4469-8022-90f061c42b29" alt="Wallet Scrutiny" height="62" align="middle"></a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="https://x.com/Trustlessbtc"><img src="https://github.com/user-attachments/assets/d97dcf22-345a-427d-961e-6f4ee308db76" alt="X-logo" height="50" align="middle"></a>
...
* **Receive address rotation:** Have 20 unused receive addresses at all times to choose from. This is a privacy feature, because address reuse links payments together.
  <img width="800" alt="Receive rotation" src="https://github.com/user-attachments/assets/71039414-0b14-44d6-8ae6-8794dec7893a" />
...
* **Change address rotation:**  To protect user's privacy even more, all change addresses are automatically derived from 1/n chain and are never reused for receiving. In tandem with the previous feature, Trustless makes it drastically harder to link and track user's BTC.
  <img width="800" alt="Change" src="https://github.com/user-attachments/assets/a5d91210-a1af-45d3-83b0-b71e90920b44" />
...
6. Sign the downloaded unsigned APK:
   ...
   `$apksigner_path sign --ks trustless-release.keystore --ks-key-alias trustless-alias --out trustless-v3.2.0-release.apk app-release-unsigned.apk`
8. Generate the official hash:
   `shasum -a 256 trustless-v3.2.0-release.apk`
...
```bash
   curl -L -o trustless-release.apk https://github.com/trustlesswallet/trustless/releases/download/3.2.0/trustless-v3.2.0-release.apk
```
