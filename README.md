...
6. Sign the downloaded unsigned APK:
   ...
   `$apksigner_path sign --ks trustless-release.keystore --ks-key-alias trustless-alias --out trustless-v3.1.0-release.apk app-release-unsigned.apk`
8. Generate the official hash:
   `shasum -a 256 trustless-v3.1.0-release.apk`
...
```bash
   curl -L -o trustless-release.apk https://github.com/trustlesswallet/trustless/releases/download/3.1.0/trustless-v3.1.0-release.apk
```
